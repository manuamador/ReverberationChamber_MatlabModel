%Example_fullFD.m sample program
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%                                                               %
%                     FREQUENCY RESPONSE                        %
...
%Loss coefficient 
Rfx = 0.998*ones(1,length(f)); %the loss coefficient Rf can be a function of the frequency
Rfy = 0.992*ones(1,length(f));
Rfz = 0.998*ones(1,length(f));
